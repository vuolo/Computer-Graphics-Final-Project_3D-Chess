...
AI_OPPONENT_ENABLED = True
AI_OPPONENT_ELO = 1350  # Make the AI aim for an engine strength of the given Elo (i.e. from 0 to 4000).

MAIN_MENU_BACKGROUND_IMAGE = 'images/menu/3.png'
SETTINGS_MENU_BACKGROUND_IMAGE = 'images/menu/1.png'
